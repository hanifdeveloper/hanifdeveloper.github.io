...
<body> 
  ...
  <div class="container">
    <div class="jumbotron">
      ...
      <hr class="my-4">
      <a class="btn btn-primary btn-lg" href="https://drive.google.com/open?id=1s4Tb5NiEwwxpJbYHXL4rBeVY758NVi1h" role="button">Download APK</a>
    </div>
    <div class="my-3 p-3 bg-white rounded shadow-sm">
      <h6 class="border-bottom border-gray pb-2 mb-0">Update</h6>
      <ul>
        <li>Intergrasi dengan xml api voltras (pesawat)</li>
        <li>Intergrasi dengan payment gateway (midtrans)</li>
        <li>Notifikasi pembayaran dengan metode bank transfer (BCA, BNI, Mandiri dan Permata)</li>
        <li>Status perubahan Booking tiket pesawat masih manual (belum menggunakan api ticketed, menunggu UAT)</li>
        <li>Allow http request</li>
      </ul>
    </div>
  </div>
