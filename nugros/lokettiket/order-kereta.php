<?php 
  $title = 'Order Tiket Kereta';
  $image = 'thumb_kereta.jpg';
  $description = 'Laporan progress order tiket kereta, dimulai dari pencarian jadwal perjalanan sampai dengan proses pembayaran';
  $update = array(
	  'Intergrasi dengan xml api voltras (kereta)',
	  'Intergrasi dengan payment gateway (midtrans)',
	  'Notifikasi pembayaran dengan metode bank transfer (BCA, BNI, Mandiri dan Permata)',
	  'Status perubahan Booking tiket kereta masih manual (belum menggunakan api ticketed, menunggu UAT)',
	  'Implementasi seatmap untuk perubahan nomer kursi yang akan dipesan',
  );
  $file_apk = 'apk/app-sandbox-release-7.apk';
  $file_video = '1NDldwEu3qglg-oQpshcuqi3gymzPxlmI';
?>
<!DOCTYPE html> 
<html> 
  <head>
